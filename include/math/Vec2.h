...
template <class CoordsSystem> struct Vec2 {
  float x{0}, y{0};
...
template <> Vec2<Iso> Vec2<Iso>::toIso() const;

template <> Vec2<Iso> Vec2<Cart>::toIso() const;

template <> Vec2<Cart> Vec2<Iso>::toCart() const;

template <> Vec2<Cart> Vec2<Cart>::toCart() const;
